...
You are Reviewer 1 for Milestone M1: R2 connection verification script (verify_r2.js).
Working Directory: c:\Apps\Skills\skills-manager\.agents\reviewer_m1_1\
...
Provide your review report in `handoff.md` in your working directory `c:\Apps\Skills\skills-manager\.agents\reviewer_m1_1\`.
