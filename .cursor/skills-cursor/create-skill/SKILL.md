...
> [!IMPORTANT]
> **Skills are AI System Prompts & Operational Guidance — NOT GitHub Project READMEs!**
> Never write a `SKILL.md` like a GitHub repository overview, project introduction, installation guide, badge list, or README.
> - **WRONG**: "Welcome to Project X! Features: - Fast - Easy. Installation: git clone... License: MIT..."
