...
- Name: library.spec.ts >> Feature 1: Books Library Grid UI >> F1-T1-5: Selecting a category filter (e.g. "Programming") hides non-matching books
- Location: tests\library.spec.ts:61:7
...
Call log:
  - waiting for locator('[data-testid="category-tab"]:has-text("Programming")')
