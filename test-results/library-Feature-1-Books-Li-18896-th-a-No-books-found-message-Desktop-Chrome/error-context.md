...
- Name: library.spec.ts >> Feature 1: Books Library Grid UI >> F1-T2-1: Searching for special characters returns empty results cleanly with a "No books found" message
- Location: tests\library.spec.ts:77:7
