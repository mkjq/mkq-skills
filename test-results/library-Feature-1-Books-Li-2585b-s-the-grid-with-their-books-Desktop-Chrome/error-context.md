...
- Name: library.spec.ts >> Feature 1: Books Library Grid UI >> F1-T1-4: Searching for an author's name updates the grid with their books
- Location: tests\library.spec.ts:44:7
