...
- Name: library.spec.ts >> Feature 1: Books Library Grid UI >> F1-T2-3: Entering a 200+ character search query handles gracefully without UI distortion
- Location: tests\library.spec.ts:103:7
