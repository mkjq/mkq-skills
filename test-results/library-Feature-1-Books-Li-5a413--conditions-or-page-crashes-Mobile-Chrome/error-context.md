...
- Name: library.spec.ts >> Feature 1: Books Library Grid UI >> F1-T2-4: Rapidly clicking different category tabs does not result in race conditions or page crashes
- Location: tests\library.spec.ts:120:7
