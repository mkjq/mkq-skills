...
- Name: library.spec.ts >> Feature 1: Books Library Grid UI >> F1-T2-2: A search query that matches zero books displays a friendly placeholder message
- Location: tests\library.spec.ts:91:7
