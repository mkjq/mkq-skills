...
- Name: library.spec.ts >> Feature 1: Books Library Grid UI >> F1-T1-2: Exactly 45 books are rendered in the grid layout
- Location: tests\library.spec.ts:22:7
...
Locator:  locator('[data-testid="book-card"]')
Expected: 45
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="book-card"]')
