...
- Name: library.spec.ts >> Feature 2: Responsive PDF Reader >> F2-T2-1: Opening a book that has an invalid R2 key fails gracefully showing an error alert/message
- Location: tests\library.spec.ts:275:7
