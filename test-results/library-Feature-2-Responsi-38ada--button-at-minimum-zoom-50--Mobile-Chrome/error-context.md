...
- Name: library.spec.ts >> Feature 2: Responsive PDF Reader >> F2-T2-3: Repeatedly clicking Zoom Out disables the button at minimum zoom (50%)
- Location: tests\library.spec.ts:313:7
