...
- Name: library.spec.ts >> Feature 2: Responsive PDF Reader >> F2-T1-4: Zoom In and Zoom Out buttons change canvas scale properties
- Location: tests\library.spec.ts:216:7
