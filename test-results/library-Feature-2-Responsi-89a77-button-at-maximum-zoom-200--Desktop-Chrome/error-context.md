...
- Name: library.spec.ts >> Feature 2: Responsive PDF Reader >> F2-T2-2: Repeatedly clicking Zoom In disables the button at maximum zoom (200%)
- Location: tests\library.spec.ts:297:7
