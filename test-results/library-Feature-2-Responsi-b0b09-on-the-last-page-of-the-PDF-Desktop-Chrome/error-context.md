...
- Name: library.spec.ts >> Feature 2: Responsive PDF Reader >> F2-T2-5: Next page button is disabled on the last page of the PDF
- Location: tests\library.spec.ts:338:7
