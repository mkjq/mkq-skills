...
- Name: library.spec.ts >> Feature 2: Responsive PDF Reader >> F2-T1-2: Verify DOM elements confirm use of canvas-based react-pdf instead of iframe
- Location: tests\library.spec.ts:173:7
