...
- Name: scenarios.spec.ts >> Tier 3: Cross-Feature Combinations >> T3-2: Search query and category filter are preserved after closing viewer
- Location: tests\scenarios.spec.ts:37:7
