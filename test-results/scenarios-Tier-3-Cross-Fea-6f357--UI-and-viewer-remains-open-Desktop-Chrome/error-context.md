...
- Name: scenarios.spec.ts >> Tier 3: Cross-Feature Combinations >> T3-3: PDF downloads from viewer UI and viewer remains open
- Location: tests\scenarios.spec.ts:70:7
