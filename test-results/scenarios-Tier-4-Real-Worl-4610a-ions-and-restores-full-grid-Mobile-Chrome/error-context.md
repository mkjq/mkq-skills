...
- Name: scenarios.spec.ts >> Tier 4: Real-World Scenarios >> T4-5: Empty search displays recovery options and restores full grid
- Location: tests\scenarios.spec.ts:267:7
